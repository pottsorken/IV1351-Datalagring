...
(2, 'Czech', 'Excellent condition, well-maintained', 1600.00, TRUE),
(3, 'Yamaha', 'Fair condition, missing one key', 85.00, FALSE),
(4, 'Conn', 'Very good condition, no issues', 180.00, FALSE),
(5, 'DW', 'Good condition, minor scratches', 125.00, TRUE),
...
(5, 'Pearl', 'Very good condition, no visible damage', 125.00, TRUE),
...
(9, 'Buffet Crampon', 'Good condition, well-kept', 115.00, TRUE),
(10, 'Hohner', 'Excellent condition, barely used', 145.00, TRUE),
...
('2023-04-01', '2023-12-01', FALSE, TRUE, 12, 1), -- Done lease for student 1

('2023-06-10', '2024-06-10', TRUE, FALSE, 18, 2), -- Active lease for student 2
('2023-05-20', '2023-11-20', FALSE, TRUE, 18, 2), -- Done lease for student 2

('2023-02-03', '2023-08-03', TRUE, FALSE, 9, 3),  -- Active lease for student 3
('2023-07-22', '2024-07-22', FALSE, TRUE, 9, 3),  -- Done lease for student 3

('2023-03-15', '2023-09-15', TRUE, FALSE, 40, 4), -- Active lease for student 4
('2023-09-01', '2024-09-01', FALSE, TRUE, 40, 4), -- Done lease for student 4

('2023-06-01', '2024-06-01', TRUE, FALSE, 53, 5), -- Active lease for student 5
('2023-05-01', '2023-11-01', FALSE, TRUE, 53, 5), -- Done lease for student 5

('2023-01-05', '2023-07-05', TRUE, TRUE, 15, 6), -- Done lease for student 6
('2023-06-01', '2024-06-01', FALSE, FALSE, 15, 6), -- Active lease for student 6

('2023-06-15', '2024-06-15', TRUE, FALSE, 25, 7), -- Active lease for student 7
('2023-03-01', '2023-09-01', FALSE, TRUE, 25, 7), -- Done lease for student 7

('2023-03-01', '2023-09-01', TRUE, TRUE, 50, 8), -- Done lease for student 8
('2023-07-01', '2024-07-01', FALSE, FALSE, 50, 8), -- Active lease for student 8

('2023-07-10', '2024-07-10', TRUE, FALSE, 22, 9), -- Active lease for student 9
('2023-09-01', '2024-09-01', FALSE, TRUE, 22, 9), -- Done lease for student 9

('2023-06-30', '2024-06-30', TRUE, TRUE, 17, 10), -- Done lease for student 10
('2023-04-15', '2023-10-15', FALSE, FALSE, 17, 10), -- Active lease for student 10

('2023-05-25', '2023-11-25', TRUE, FALSE, 39, 11), -- Active lease for student 11
('2023-06-20', '2024-06-20', FALSE, TRUE, 39, 11), -- Done lease for student 11

('2023-08-01', '2024-08-01', TRUE, TRUE, 35, 12), -- Done lease for student 12
('2023-07-10', '2024-07-10', FALSE, FALSE, 35, 12), -- Active lease for student 12

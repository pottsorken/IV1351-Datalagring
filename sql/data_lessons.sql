...
INSERT INTO individual_lesson (level_id, date, state_id, location, pricing_id, instructor_id, slot_id, instrument_type_id)
VALUES
    (2, '2024-11-30', 1, 'Room J', 4, 33, 4, 9);
    (1, '2024-12-01', 2, 'Room K', 5, 12, 3, 7),
    (2, '2024-12-02', 4, 'Room L', 10, 18, 8, 4),
    (3, '2024-12-03', 3, 'Room M', 7, 5, 12, 6),
    (1, '2024-12-04', 1, 'Room N', 12, 25, 14, 8),
    (3, '2024-12-05', 3, 'Room O', 3, 20, 7, 2),
    (2, '2024-12-06', 4, 'Room P', 9, 30, 11, 10),
    (1, '2024-12-07', 2, 'Room Q', 4, 8, 2, 5),
    (2, '2024-12-08', 1, 'Room R', 8, 35, 6, 1),
    (3, '2024-12-09', 3, 'Room S', 15, 22, 10, 9),
    (1, '2024-12-10', 2, 'Room T', 18, 29, 12, 3);

-- DATA FOR GROUP_LESSON
    INSERT INTO group_lesson (level_id, date, state_id, location, pricing_id, instructor_id, slot_id, instrument_type_id, max_number_of_students, min_number_of_students, registered_number_of_students)
    VALUES
    (1, '2024-11-21', 2, 'Room A', 3, 5, 7, 1, 10, 5, 0),
    (2, '2024-11-22', 4, 'Room B', 12, 8, 14, 4, 15, 7, 0),
    (3, '2024-11-23', 1, 'Room C', 7, 20, 2, 3, 20, 10, 0),
    (1, '2024-11-24', 3, 'Room D', 2, 15, 10, 2, 12, 6, 0),
    (2, '2024-11-25', 4, 'Room E', 9, 25, 5, 6, 18, 8, 0),
    (3, '2024-11-26', 2, 'Room F', 11, 18, 8, 7, 25, 10, 0),
    (1, '2024-11-27', 1, 'Room G', 5, 35, 13, 8, 30, 12, 0),
    (2, '2024-11-28', 3, 'Room H', 14, 29, 6, 5, 20, 8, 0),
    (3, '2024-11-29', 4, 'Room I', 16, 10, 12, 10, 15, 5, 0),

    --  DATA FOR ENSEMBLE
    INSERT INTO ensemble_lesson (level_id, date, state_id, location, pricing_id, instructor_id, slot_id, genre, max_number_of_students, min_number_of_students, registered_number_of_students)
    VALUES
    (1, '2024-11-21', 2, 'Room A', 3, 5, 7, 'Jazz', 15, 5, 0),
    (2, '2024-11-22', 4, 'Room B', 12, 8, 14, 'Classical', 20, 8, 0),
    (3, '2024-11-23', 1, 'Room C', 7, 20, 2, 'Pop', 25, 10, 0),
    (1, '2024-11-24', 3, 'Room D', 2, 15, 10, 'Rock', 30, 12, 0),
    (2, '2024-11-25', 4, 'Room E', 9, 25, 5, 'Blues', 18, 6, 0),
    (3, '2024-11-26', 2, 'Room F', 11, 18, 8, 'Folk', 22, 9, 0),
    (1, '2024-11-27', 1, 'Room G', 5, 35, 13, 'Hip-hop', 25, 10, 0),
    (2, '2024-11-28', 3, 'Room H', 14, 29, 6, 'Latin', 18, 7, 0),
    (3, '2024-11-29', 4, 'Room I', 16, 10, 12, 'Reggae', 20, 8, 0),
    (2, '2024-11-30', 1, 'Room J', 4, 33, 4, 'Electronic', 15, 5, 0);

...
-- DATA FOR GROUP_LESSON
    ...
    (1, '2024-11-21', 2, 'Room A', 3, 5,  'Jazz', 10, 3, 0),
    (2, '2024-11-22', 4, 'Room B', 12, 8,  'Classical', 12, 4, 0),
    (3, '2024-11-23', 1, 'Room C', 7, 20,  'Pop', 15, 5, 0),
    (1, '2024-11-24', 3, 'Room D', 2, 15,  'Jazz', 8, 2, 0),
    (2, '2024-11-25', 4, 'Room E', 9, 25,  'Blues', 10, 3, 0),
    (3, '2024-11-26', 2, 'Room F', 11, 18,  'Pop', 12, 4, 0),
    (1, '2024-11-27', 1, 'Room G', 5, 35,  'Classical', 10, 3, 0),
    (2, '2024-11-28', 3, 'Room H', 14, 29,  'Jazz', 3, 2, 0),
    (2, '2024-11-28', 3, 'Room H', 14, 29,  'Jazz', 6, 2, 0),
    (3, '2024-11-29', 4, 'Room I', 16, 10,  'Blues', 15, 5, 0),
    (2, '2024-11-30', 1, 'Room J', 4, 33,  'Rock', 0, 0, 0),
    (1, '2024-11-29', 2, 'Room A', 3, 5,  'Jazz', 2, 2, 0),
    (2, '2024-11-30', 4, 'Room B', 12, 8,  'Pop', 7, 2, 0),
    (3, '2024-12-01', 1, 'Room C', 7, 20,  'Classical', 6, 1, 0),
    (1, '2024-12-02', 3, 'Room D', 2, 15,  'Blues', 9, 3, 0),
    (2, '2024-12-03', 4, 'Room E', 9, 25,  'Jazz', 0, 0, 0),
    (3, '2024-12-04', 2, 'Room F', 11, 18,  'Pop', 1, 1, 0),
    (3, '2024-12-04', 4, 'Room I', 16, 10,  'Blues', 9, 3, 0),
    (1, '2024-12-05', 1, 'Room G', 5, 35,  'Classical', 2, 1, 0),
    (2, '2024-12-05', 1, 'Room J', 4, 33,  'Rock', 8, 2, 0);
